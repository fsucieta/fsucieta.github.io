...
L'examen forensique et légistique des arrêtés ministériels, délibérations territoriales et actes administratifs relatifs à l'enquête **Le Controle De Legalite Et Censure** met en évidence :

1. **Audit des arrêtés d'application et décrets d'encadrement :** L'analyse des textes officiels encadrant des bordereaux de télétransmission préfectorale `@CTES` et des déférés du TA de Bastia montre une faille juridique majeure favorisant la sélectivité des recours ciblant à 70 % les petites communes rurales sans moyens juridiques.
...
Pour imposer la transparence et forcer la communication des preuves administratives cachées dans l'enquête **Le Controle De Legalite Et Censure**, la saisine de la CADA (Art. L. 311-1 CRPA) permet d'exiger les 4 séries de documents officiels suivants :

1. **Les registres d'arbitrage et arrêtés préfectoraux :** Demande de communication formelle de les bordereaux de télétransmission des actes municipaux du système `@CTES`.
2. **Les procès-verbaux de contrôle et bilans techniques :** Injonction d'accès à les registres chronologiques des déférés préfectoraux au TA de Bastia.
...
### 🎯 Documents-Cibles Spécifiques à l'Enquête : *Le Contrôle De Légalité Et La Censure Administrative*
