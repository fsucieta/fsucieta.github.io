...
sources:
  ...
  - name: "Corsica Fibra / Collectivité de Corse : Bilan du Réseau d'Initiative Publique (RIP)"
    url: "https://www.corsica-fibra.fr/"
...
<div class="article-content" style="font-family: 'Georgia', serif; font-size: 1.1rem; line-height: 1.85; color: #1e293b;">
    ...
    <div style="background: #f1f5f9; border: 1px solid #cbd5e1; padding: 1.5rem; border-radius: 10px; margin-top: 1.5rem;">
        ...
        <p style="font-size: 0.95rem; color: #334155; margin-bottom: 0;">Saisissez le président de votre intercommunalité ou votre maire pour obtenir la copie des contrats d'hébergement des serveurs et données d'état civil. Exigez la vérification de la conformité RGPD et du lieu de stockage physique des serveurs.</p>
                    ...
                    <p>Pour contrer les abus identifiés dans l'enquête #19, la réponse citoyenne doit s'appuyer sur la transparence intégrale des documents publics. Conformément aux dispositions des articles L. 300-1 et suivants du Code des Relations entre le Public et l'Administration (CRPA), chaque citoyen peut exiger la transmission sans frais des procès-verbaux de contrôle, des registres fonciers et des rapports d'audit administratif.</p>
    ...
    <p>Pour permettre à chaque citoyen, association ou collectif d'agir efficacement sur le terrain de la légalité pour l'enquête <strong>#19</strong>, la Cellule d'Investigation CASA DI CRISTALE met à disposition ce protocole d'action en trois étapes juridiques d'accès aux documents administratifs :</p>
