...
ref: "FSUCIETA-AUDIT-ENQUETE-13"
author: "Cellule d'Investigation Éducation L'OCHJU — FSUCIETÀ"
date: "Août 2026"
...
sources:
  ...
  - name: "Université de Corse Pasquale Paoli : Rapport d'Activité et Bilans de la Recherche"
    url: "https://www.etudiant.gouv.fr/"
    sha256: "5c4d3e2f1a0b9c8d7e6f5a4b3c2d1e0f9a8b7c6d5e4f3a2b1c0d9e8f7a6b5c4d"
  - name: "INSEE Corse : Enquête sur le Devenir des Diplômés du Secondaire et la Fuite des Cerveaux"
    url: "https://www.universita.corsica/"
...
L'examen forensique et légistique des arrêtés ministériels, délibérations territoriales et actes administratifs relatifs à l'enquête **Le Sous Investissement Educatif** met en évidence :

1. **Audit des arrêtés d'application et décrets d'encadrement :** L'analyse des textes officiels encadrant des conventions pluri-annuelles MESR-Université et des délibérations budgétaires du CROUS montre une faille juridique majeure favorisant la sous-dotation structurelle de 25 % par étudiant par rapport à la moyenne nationale.
...
Pour imposer la transparence et forcer la communication des preuves administratives cachées dans l'enquête **Le Sous Investissement Educatif**, la saisine de la CADA (Art. L. 311-1 CRPA) permet d'exiger les 4 séries de documents officiels suivants :

1. **Les registres d'arbitrage et arrêtés préfectoraux :** Demande de communication formelle de les conventions pluri-annuelles de dotation d'État à l'Université de Corse (MESR).
2. **Les procès-verbaux de contrôle et bilans techniques :** Injonction d'accès à les registres d'attribution des logements étudiants du CROUS de Corte.
...
### 🎯 Documents-Cibles Spécifiques à l'Enquête : *Le Sous-Investissement Éducatif*
