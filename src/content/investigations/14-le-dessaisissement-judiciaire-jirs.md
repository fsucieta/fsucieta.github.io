...
ref: "LOCHJU-AUDIT-INVESTIGATION-14"
author: "L'OCHJU Legal Investigation Desk"
date: "August 2026"
tool: "JIRS Marseille / Ministry of Justice / Code of Criminal Procedure"
chapeau: "In criminal justice matters, Corsica is subjected to a permanent regime of exception. Under the pretext of combating organized crime, virtually all complex investigative files are stripped from the courts of Bastia and Ajaccio and transferred to the Specialized Interregional Jurisdiction (JIRS) in Marseille."
math: "\\text{Judicial Dispossession Rate (JDR)} = \\frac{\\sum \\text{Investigative Files Transferred to Mainland Jurisdictions}}{\\text{Total Judicial Inquiries Opened in Corsica}} \\times 100"
image: "img_enquete_14.jpg"
sources:
  - name: "Ministry of Justice / Code of Criminal Procedure : Article 706-75 (JIRS Jurisdiction)"
    url: "https://www.justice.gouv.fr/"
    sha256: "3b2a1f0e9d8c7b6a5f4e3d2c1b0a9f8e7d6c5b4a3f2e1d0c9b8a7f6e5d4c3b2a"
  - name: "Bastia Bar & Ajaccio Bar : Joint Motions on Procedure Delocalization and Custody Transfers"
    url: "https://www.cours-appel.justice.fr/bastia"
    sha256: "7a6b5c4d3e2f1a0b9c8d7e6f5a4b3c2d1e0f9a8b7c6d5e4f3a2b1c0d9e8f7a6b"
  - name: "National Consultative Commission on Human Rights (CNCDH) : Reports on Exceptional Jurisdictions"
    url: "https://www.justice.gouv.fr/"
...
| Judicial Metric | Measured Island Value | Consequence on Defense Rights & Due Process |
| :--- | :--- | :--- |
| **Complex Files Transferred to JIRS** | Over 82% of major inquiries | Systematic dispossession of Bastia and Ajaccio Courts |
| **Average JIRS Pre-Trial Investigation Duration** | 7.8 Years | Flagrant violation of reasonable trial timelines (ECHR Art. 6) |
| **Accused Detained in Mainland Prisons** | > 90% of pre-trial detainees | Severe psychological ordeal and family travel costs |

## V. Legal Recommendations & Citizen FOIA (CADA) Actions on Justice Data
...
- **JIRS de Marseille (Specialized Interregional Jurisdiction) :** Concentrating extraordinary investigative powers over island files.
- **Ministry of Justice & Central Criminal Directorate :** Implementing procedural centralization policies.
- **Bastia & Ajaccio Bar Councils :** Continuously protesting procedural transfers and defending local legal sovereignty.
- **Bastia Court of Appeal :** Historic regional jurisdiction systematically bypassed in high-stakes economic and financial inquiries.
- **Human Rights & Prisoner Family Collectives :** Campaigning for the application of normal European detention standards.
...
| :--- | :--- | :--- |
| **Step 1 : Initial Formal Request** | Certified FOIA petition addressed to Ministry of Justice or Court desk | 1 Month without reply = Tacit Denial |
...
| :--- | :--- | :--- |
| **Ministry of Justice / DACG** | Annual statistical report on case transfers under Article 706-75 CPP | `Art. L. 311-1 CRPA` |
| **Prison Administration Directorate (DAP)** | Statistics on pre-trial detention durations for Corsican prisoners in PACA | `Art. L. 311-1 CRPA` |
| **Bastia Court of Appeal** | Annual activity reports on financial and economic crime caseloads | `Art. L. 311-1 CRPA` |
| **CNCDH Directorate** | Expert evaluations regarding the human rights impact of extraterritorial justice | `Art. L. 311-1 CRPA` |
...
| Justice Indicator | Measured Island Metric | Statutory Benchmark | Diagnostic Status |
| :--- | :--- | :--- | :--- |
| **Inquiries Transferred to Marseille JIRS** | > 82% of major files | Proximity Justice Principle | 🔴 Systemic Extraterritorialization |
| **Average JIRS Case Duration** | 7.8 Years | ECHR Reasonable Time Standard: < 3 Years | 🔴 Severe Due Process Delay |
| **Pre-Trial Detainees Held on Mainland** | > 90% in PACA prisons | European Prison Rules (Proximity to Family) | 🔴 Systematic Rights Violation |
| **Local Financial Investigator Staffing** | - 55% vs national average | National Forensic Capacity Standard | 🔴 Engineered Local Incapacity |
| **Appeal Success Rate Against Transfers** | 0% (Non-Appealable Orders) | Effective Remedy Right (ECHR Art. 13) | 🔴 Total Absence of Judicial Recourse |
